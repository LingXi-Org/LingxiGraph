...
<Cards>
  <Card title="Embedded runtime" icon="python" href="/docs/en/quickstart/first-graph">Create and invoke your first state graph.</Card>
  <Card title="Server runtime" icon="server" href="/docs/en/quickstart/agent-server">Scaffold a project and open Studio.</Card>
</Cards>
