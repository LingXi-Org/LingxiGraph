...
<Cards>
  <Card title="嵌入式运行" icon="python" href="/docs/zh/quickstart/first-graph">创建并调用第一个状态图。</Card>
  <Card title="服务端运行" icon="server" href="/docs/zh/quickstart/agent-server">脚手架项目并打开 Studio。</Card>
</Cards>
