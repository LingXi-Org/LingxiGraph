...
This documentation targets LingxiGraph `2.1.0` on Python 3.11–3.13. Public server endpoints live under `/v1`. Each run pins a graph ID and version, so a deployment cannot change queued or paused work.
